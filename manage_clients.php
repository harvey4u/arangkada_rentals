...
// Fetch all clients with their rental history
$stmt = $pdo->query("
    SELECT u.*, 
    ...
    LEFT JOIN rentals rt ON u.id = rt.user_id
    WHERE r.name = 'client'
...
<head>
    ...
    <title>Manage Clients - Arangkada Car Rentals</title>
...
<body>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="rental-badges">
                                        <span class="rental-badge active">
                                            <i class="fas fa-car"></i>
                                            <?= $client['active_rentals'] ?> Active
                                        </span>
                                        <span class="rental-badge total">
                                            <i class="fas fa-history"></i>
                                            <?= $client['total_rentals'] ?> Total
                                        </span>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-secondary" onclick="viewRentals(<?= $client['id'] ?>)">
                                            <i class="fas fa-history"></i>
                                            View History
                                        </button>
    ...
    <script>
        ...
        function deleteClient(clientId) {
            if (confirm('Are you sure you want to delete this client? This will also delete all associated rental records.')) {
                // Add delete functionality here
            }
        }

        function viewRentals(clientId) {
            // Add rental history view functionality here
            window.location.href = `client_rentals.php?id=${clientId}`;
        }
