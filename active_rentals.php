...
try {
    ...
    $rentals = [];
    $error_message = 'Error fetching active rentals: ' . $e->getMessage();
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Active Rentals - Arangkada</title>
...
<div class="main-content">
    <div class="container py-4">
        ...
        <div class="row">
            ...
            <?php else: ?>
                <div class="col-12">
                    <div class="alert alert-info">You have no active rentals at the moment.</div>
                </div>
            <?php endif; ?>
        </div>
    </div>
